...
Each project has its own `CLAUDE.md` and `lessons.md`. Read those before touching anything in that subdirectory.
...
## Starting a New Client Tool

Use the `/scaffold` skill to set up the correct structure for a new project.
